...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "AdGenius AI — Viral Ads Generated in Seconds" },
      { name: "description", content: "Generate high-converting UGC ads, viral hooks, Reels scripts and TikTok content with advanced prompt engineering." },
      { name: "author", content: "AdGenius AI" },
